...
func BufferPsi(file *os.File, pos *int64, pid uint16, mpegPacket MpegPacket) error {
...
func BufferPes(file *os.File, pos *int64, pcrPid uint16, programInfos []ProgramInfo) error {
	tsBuffer := make([]byte, tsPacketSize)
